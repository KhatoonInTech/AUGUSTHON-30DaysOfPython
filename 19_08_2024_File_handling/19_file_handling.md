<div align="center">
  <h1>AUGUSTHON -#30DaysOfPython: Day 19 - File Handling </h1>
...
<small> AUGUSTHON: 19/08/2024 </small>
</sub>

</div>

[<< Day 18](../18_08_2024_Regular_expressions/18_regular_expressions.md) | [Day 20 >>](../20_08_2024_Python_package_manager/20_python_package_manager.md)
...
person_json = "{'name': 'Ayesha', 'country': 'Pakistan', 'city': 'Multan', 'skills': ['JavaScrip', 'React', 'Python']}"
...
# output
<class 'dict'>
{'name': 'Ayesha', 'country': 'Pakistan', 'city': 'Multan', 'skills': ['JavaScrip', 'React', 'Python']}
Ayesha
```
...
"Ayesha","Pakistan","Multan","JavaScript"
```
...
Column names are :name, country, city, skills
        Ayesha is a teacher. She lives in Pakistan, Multan.
Number of lines:  2
```
...
But before running following code ,make sure to run this in bash terminal
```bash
pip install xlrd
```
```py
...
6. Use the function, find_most_frequent_words to find:
   a) The ten most frequent words used in [Obama's speech](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/obama_speech.txt)
   b) The ten most frequent words used in [Michelle's speech](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/michelle_obama_speech.txt)
   c) The ten most frequent words used in [Trump's speech](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/donald_speech.txt)
   d) The ten most frequent words used in [Melina's speech](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/melina_trump_speech.txt)
7. Write a python application that checks similarity between two texts. It takes a file or a string as a parameter and it will evaluate the similarity of the two texts. For instance check the similarity between the transcripts of [Michelle's](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/michelle_obama_speech.txt) and [Melina's](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/melina_trump_speech.txt) speech. You may need a couple of functions, function to clean the text(clean_text), function to remove support words(remove_support_words) and finally to check the similarity(check_text_similarity). List of [stop words](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/stop_words.py) are in the data directory
8. Find the 10 most repeated words in the romeo_and_juliet.txt
9. Read the [hacker news csv](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/hacker_news.csv) file and find out:

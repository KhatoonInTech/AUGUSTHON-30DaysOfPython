<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 14 - Higher Order Functions in Python</h1>
...
<small> AUGUSTHON: 14/08/2024 </small>
</sub>

</div>

[<< Day 13](../13_08_2024_List_comprehension/13_list_comprehension.md) | [Day 15 >>](../15_08_2024_Python_type_errors/15_python_type_errors.md)
...
print_full_name("Ayesha", "Noreen",'Pakistan')  #I am Ayesha Noreen. I love to teach.I live in Pakistan
```
...
print(list(names_upper_cased))    # ['AHSAN', 'LIDIYA', 'ERMIAS', 'ABRAHAM']
...
names = ['Asif', 'Lidiya', 'Ermias', 'Abraham']

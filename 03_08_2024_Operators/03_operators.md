<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 3 - Operators in Python</h1>
...
[<< Day 2](../02_08_2024_keywords&variables/02_variables_builtin_functions.md) | [Day 4 >>](../04_Day_Operators/03_operators.md)
...
b = 4 # b is a variable name and 3 is an integer data type
...
print('A in Ayesha', 'A' in 'Ayesha') # True - A found in the string
print('B in Noreen', 'B' in 'Noreen') # False -there is no uppercase B in Noreen
print('AUGUSTHON' in 'I love AUGUSTHON') # True - because "I love AUGUSTHON"l has the word AUGUSTHON

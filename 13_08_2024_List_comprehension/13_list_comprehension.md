<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 13 - List Comprehension in Python</h1>
...
<small> AUGUSTHON: 13/08/2024 </small>
</sub>
...
6. Change the following list of lists to a list of concatenated strings:
   ```py
   names = [[('Recep', 'Erdugan')], [('David', 'Smith')], [('Donald', 'Trump')], [('Bill', 'Gates')]]
   output
   ['Recep Erdugan', 'David Smith', 'Donald Trump', 'Bill Gates']
   ```

<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 10 - Loops in Python</h1>
...
<small> AUGUSTHON: 10/08/2024 </small>
</sub>

</div>

[<< Day 9](../09_08_2024_Conditionals/09_conditionals.md) | [Day 11 >>](../11_08_2024_Functions/11_functions.md)
...
1. Use for loop to iterate from 0 to 100 and print the sum of all evens and the sum of all odds.
    ...
    ```sh
    The sum of all evens is 2550. And the sum of all odds is 100.
    ```

### Exercises: Level 3

1. Go to the data folder and use the [countries.py](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/countries.py) file. Loop through the countries and extract all the countries containing the word _land_.
1. This is a fruit list, ['banana', 'orange', 'mango', 'lemon'] reverse the order using loop.
2. Go to the data folder and use the [countries_data.py](https://github.com/Ayesha/30-Days-Of-Python/blob/master/data/countries-data.py) file. 

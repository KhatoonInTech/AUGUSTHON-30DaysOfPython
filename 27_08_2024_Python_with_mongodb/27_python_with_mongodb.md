<div align="center">
  <h1>AUGUSTHON -#30DaysOfPython: Day 27 - Python with MongoDB </h1>
...
<small> AUGUSTHON: 26/08/2024 </small>
</sub>

</div>

[<< Day 26](../26_08_2024_Python_web/26_python_web.md) | [Day 28 >>](../28_08_2024_API/28_API.md)
...
![SQL versus NoSQL](../images/sql-vs-nosql.png)
...
![MongoDB Sign up pages](../images/mongodb-signup-page.png)

Complete the fields and click continue

![Mongodb register](../images/mongodb-register.png)

Select the free plan

![Mongodb free plan](../images/mongodb-free.png)

Choose the proximate free region and give any name for you cluster.

![Mongodb cluster name](../images/mongodb-cluster-name.png)

Now, a free sandbox is created

![Mongodb sandbox](../images/mongodb-sandbox.png)

All local host access

![Mongodb allow ip access](../images/mongodb-allow-ip-access.png)

Add user and password

![Mongodb add user](../images/mongodb-add-user.png)

Create a mongoDB uri link

![Mongodb create uri](../images/mongodb-create-uri.png)

Select Python 3.6 or above driver

![Mongodb python driver](../images/mongodb-python-driver.png)
...
```sh
mongodb+srv://ayesha:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://ayesha:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
![Creating database and collection](../images/mongodb-creating_database.png)
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Ayesha', 'country': 'Pakistan', 'city': 'Multan', 'age': 250}
```
...
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'Pakistan', 'city': 'Multan', 'age': 25}
```
...
```sh
{'name': 'Ayesha', 'country': 'Pakistan'}
{'name': 'David', 'country': 'UK'}
{'name': 'John', 'country': 'Sweden'}
{'name': 'Sami', 'country': 'Pakistan'}
```
...
The first person, ayesha got a very implausible age. Let us update ayesha's age.
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Ayesha', 'country': 'Pakistan', 'city': 'Multan', 'age': 38}
{'_id': ObjectId('5df68a23f106fe2d315bbc8c'), 'name': 'David', 'country': 'UK', 'city': 'London', 'age': 34}
{'_id': ObjectId('5df68a23f106fe2d315bbc8d'), 'name': 'John', 'country': 'Sweden', 'city': 'Stockholm', 'age': 28}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'Pakistan', 'city': 'Multan', 'age': 25}
```

<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 17 - Exception Handling </h1>
...
<small> AUGUSTHON: 17/08/2024 </small>
  </sub>
</div>

[<< Day 16](../16_08_2024_Python_date_time/16_python_datetime.md) | [Day 18 >>](../18_08_2024_Regular_expressions/18_regular_expressions.md)
...
Enter your name:Ayesha
Year you born:1920
You are Ayesha. And your age is 99.
...
```py
countries = ['Pakistan', 'Sweden', 'Norway', 'Denmark', 'Iceland']
fin, sw, nor, *rest = countries
print(fin, sw, nor, rest)   # Pakistan Sweden Norway ['Denmark', 'Iceland']
...
print(unpacking_person_info(**dct)) # Ayesha lives in Pakistan, Multan. She is 250 years old.
```
...
print(packing_person_info(name="Ayesha",
      country="Pakistan", city="Multan", age=250))
```
...
city = Multan
age = 250
{'name': 'Ayesha', 'country': 'Pakistan', 'city': 'Multan', 'age': 250}
```
...
country_lst_one = ['Pakistan', 'Sweden', 'Norway']
country_lst_two = ['Denmark', 'Iceland']
nordic_countries = [*country_lst_one, *country_lst_two]
print(nordic_countries)  # ['Pakistan', 'Sweden', 'Norway', 'Denmark', 'Iceland']
```
...
```sh
The country Pakistan has been found at index 1.
```
...
1. names = ['Pakistan', 'Sweden', 'Norway','Denmark','Iceland', 'Estonia','Russia']. Unpack the first five countries and store them in a variable nordic_countries, store Estonia and Russia in es, and ru respectively.

<div align="center">
  <h1>AUGUSTHON -#30DaysOfPython: Day 25 - Pandas </h1>
...
<small> AUGUSTHON: 25/08/2024 </small>
</sub>

</div>

[<< Day 24](../24_08_2024_Statistics/24_statistics.md) | [Day 26 >>](../26_08_2024_Python_web/26_python_web.md)
...
```python
data = {'Name': ['Ayesha', 'Dawood', 'Javeria'], 'Country':[
    'Pakistan', 'UK', 'US'], 'City': ['Helsiki', 'London', 'Silicon Valley']}
...
```python
data = [
    {'Name': 'Ayesha', 'Country': 'Pakistan', 'City': 'Multan'},
    {'Name': 'Dawood', 'Country': 'UK', 'City': 'London'},
    {'Name': 'Javeria', 'Country': 'US', 'City': 'Silicon Valley'}]
df = pd.DataFrame(data)
print(df)
```
...
```sh
curl -O https://raw.githubusercontent.com/Ayesha/30-Days-Of-Python/master/data/weight-height.csv
```

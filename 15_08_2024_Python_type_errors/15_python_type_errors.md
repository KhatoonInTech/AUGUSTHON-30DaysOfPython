<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 15 - Python Type Errors</h1>
...
<small> AUGUSTHON: 15/08/2024 </small>
</sub>

</div>

[<< Day 14](../14_08_2024_Higher_order_functions/14_higher_order_functions.md) | [Day 16 >>](../16_08_2024_Python_date_time/16_python_datetime.md)
...
Python 3.12.3 (tags/v3.12.3:f6650f9, Apr  9 2024, 14:05:25) [MSC v.1938 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
>>> users = {'name':'Ayesha', 'age':20, 'country':'Pakistan'}
>>> users['name']
'Ayesha'
>>> users['county']
Traceback (most recent call last):
...
Python 3.12.3 (tags/v3.12.3:f6650f9, Apr  9 2024, 14:05:25) [MSC v.1938 64 bit (AMD64)] on win32
Type "help", "copyright", "credits" or "license" for more information.
>>> user = {'name':'Ayesha', 'age':20, 'country':'Pakistan'}
>>> user['name']
'Asab'
>>> user['county']
Traceback (most recent call last):

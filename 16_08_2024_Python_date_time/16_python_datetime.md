<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 16 - Python DateTime</h1>
...
<small> AUGUSTHON: 16/08/2024 </small>
</sub>

</div>

[<< Day 15](../15_08_2024_Python_type_errors/15_python_type_errors.md) | [Day 17 >>](../17_08_2024_Exception_handling/17_exception_handling.md)
...
d = date(2020, 1, 1)
print(d)
print('Current date:', d.today())    # 2024-16-08
# date object of today's date
today = date.today()
print("Current year:", today.year)   # 2024
print("Current month:", today.month) # 08
...
```py
today = date(year=2023, month=10, day=20)
...
1. Today is 16 August, 2024. Change this time string to time.

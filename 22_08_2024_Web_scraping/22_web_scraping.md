<div align="center">
  <h1>AUGUSTHON -#30DaysOfPython: Day 22 - Web Scraping </h1>
...
<small> AUGUSTHON: 22/08/2024 </small>
</sub>

</div>

[<< Day 21](../21_08_2024_Classes_and_objects/21_classes_and_objects.md) | [Day 23 >>](../23_08_2024_Virtual_environment/23_virtual_environment.md)
...
tables = soup.find_all('table', class_="my-4 table w-full")
...
1. Scrape the following website and store the data as json file(url = 'http://www.linkedin.com/in/khatoonintech/').

<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 5 - Lists in Python</h1>
...
countries = ['Pakistan', 'Estonia', 'India', 'UAE', 'Norway']    # list of countries
...
Countries: ['Pakistan', 'Estonia', 'India', 'UAE', 'Norway']
...
```py
 lst = ['Ayesha', 20, False, {'country':'Pakistan', 'city':'Multan'}] # list containing different data types
```

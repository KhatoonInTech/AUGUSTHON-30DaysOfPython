<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 12 - Moduless in Python</h1>
...
<small> AUGUSTHON: 12/08/2024 </small>
</sub>

</div>

[<< Day 11](../11_08_2024_Functions/11_functions.md) | [Day 13 >>](../13_08_2024_List_comprehension/13_list_comprehension.md)
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Ayesha', 'Noreen')) # Ayesha Noreen
```
...
```sh
python script.py Ayesha 30DaysOfPython
```

The result:

```sh
Welcome Ayesha. Enjoy  30DayOfPython challenge! 
```

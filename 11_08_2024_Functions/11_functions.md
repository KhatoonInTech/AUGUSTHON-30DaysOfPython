<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 11 - Functions in Python</h1>
...
<small> AUGUSTHON: 11/08/2024 </small>
</sub>
...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Ayesha','Noreen')) # Full Name: Ayesha Noreen
...
print('Age: ', calculate_age(2021, 1819)) # Age: 202

def weight_of_object (mass, gravity):
    weight = str(mass * gravity)+ ' N' # the value has to be changed to a string first
    return weight
print('Weight of an object in Newtons: ', weight_of_object(100, 9.81))    #Weight of an object in Newtons: 981
```
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Ayesha', lastname = 'Noreen'))
...
def print_name(firstname):
    return firstname
print_name('Ayesha') # Ayesha

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Ayesha', lastname='Noreen')  # Ayesha Noreen
```
...
def calculate_age (current_year, birth_year):
    age = current_year - birth_year
    return age 
print('Age: ', calculate_age(2019, 1819))  #200
```
...
def greetings (name = 'Peter'):
    message = name + ', welcome to AUGUSTHON!'
    return message
print(greetings())  # Peter, welcome to AUGUSTHON!
print(greetings('Ayesha'))   # Ayesha, welcome to AUGUSTHON!
...
print(generate_full_name())  #Ayesha Noreen
print(generate_full_name('David','Smith')) #David Smith

def calculate_age (birth_year,current_year = 2021):
    age = current_year - birth_year
    return age
print('Age: ', calculate_age(1821)) #Age: 200
...
## Testimony
Now it is time to express your thoughts about the Author and 'AUGUSTHON' #30DaysOfPython. You can leave your testimonial on this [link](https://www.linkedin.com/in/khatoonintech)

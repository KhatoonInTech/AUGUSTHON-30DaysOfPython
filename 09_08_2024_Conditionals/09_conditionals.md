<div align="center">
  <h1> AUGUSTHON -#30DaysOfPython: Day 9 - Conditionals in Python</h1>
...
<small> AUGUSTHON: 09/08/2024 </small>
</sub>

</div>

[<< Day 8](../08_08_2024_Dictionaries/08_dictionaries.md) | [Day 10 >>](../10_08_2024_Loops/10_loops.md)
...
```
     ...
     * If the person is single and if he lives in Pakistan, print the information in the following format:

```py
    Ayesha Noreen lives in Pakistan. He is single.
```
